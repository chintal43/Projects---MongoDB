...
var api_key = 'SmC_pg3ZABGPaGAmkRmB0nD1kSWXY_SP';

function getTasks(){
	$.get( "https://api.mongolab.com/api/1/databases/taskmanager2/collections/tasks?apiKey=SmC_pg3ZABGPaGAmkRmB0nD1kSWXY_SP", function( data ) {
...
function addTask(){
	...
	$.ajax({ url: "https://api.mongolab.com/api/1/databases/taskmanager2/collections/tasks?apiKey=SmC_pg3ZABGPaGAmkRmB0nD1kSWXY_SP",
		data: JSON.stringify({
			"task_name" : task_name,
			"category": category,
			"due_date": due_date,
...
function editTask(){
	...
	$.ajax({url: 'https://api.mongolab.com/api/1/databases/taskmanager2/collections/tasks/'+task_id+'?apiKey=SmC_pg3ZABGPaGAmkRmB0nD1kSWXY_SP',
		data: JSON.stringify({
		    "task_name" : task_name,
			"category": category,
			"due_date": due_date,
...
function deleteTask(){
	...
	$.ajax({ 
		url: 'https://api.mongolab.com/api/1/databases/taskmanager2/collections/tasks/'+task_id+'?apiKey=SmC_pg3ZABGPaGAmkRmB0nD1kSWXY_SP',
		type: "DELETE",
		async: true,
		timeout: 300000,
		success: function (data) { 
...
function getTask(){
	var task_id = sessionStorage.getItem('currentTaskId');
	$.get( 'https://api.mongolab.com/api/1/databases/taskmanager2/collections/tasks/'+task_id+'?apiKey=SmC_pg3ZABGPaGAmkRmB0nD1kSWXY_SP', function( data ) {
...
function getCategoryOptions(){
	$.get( "https://api.mongolab.com/api/1/databases/taskmanager2/collections/categories?apiKey=SmC_pg3ZABGPaGAmkRmB0nD1kSWXY_SP", function( data ) {
       	var output;
        $.each(data, function(key, data){
        	console.log(data);
...
function addCategory(){
	...
	$.ajax({
		url:'https://api.mongolab.com/api/1/databases/taskmanager2/collections/categories?apiKey='+api_key,
		data: JSON.stringify({
...
function editCategory(){
	...
	var category_name = $('#category_name').val();
	$.ajax({
		url:'https://api.mongolab.com/api/1/databases/taskmanager2/collections/categories/'+category_id+'?apiKey='+api_key,
		data: JSON.stringify({
			"category_name": category_name
		}),
		type:'PUT',
...
function getCategory(){
	var category_id = sessionStorage.getItem('currentCategoryId');
	$.get('https://api.mongolab.com/api/1/databases/taskmanager2/collections/categories/'+category_id+'?apiKey='+api_key, function(data){
